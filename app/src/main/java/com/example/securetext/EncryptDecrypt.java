...
public class EncryptDecrypt {
    ...
    public static String encrypt(String message, String myKey) {
        try {
            ...
            byte[] encryptedValues = cipher.doFinal(message.getBytes());
    ...
    public static String decrypt(String message, String myKey) throws BadPaddingException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException {

        byte[] combined = Base64.decode(message, Base64.DEFAULT);
